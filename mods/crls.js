...
handlers.push(
  getHandler({ method: "get",
      path: "/crls/:id/suspend/:days", func: function (req, res, ctx) {
...
handlers.push(
  getHandler({ method: "get",
      path: "/crls/:id/archive", func: function (req, res, ctx) {
    console.log("Params: " + JSON.stringify(req.params));
    res.json({ "req" : req });
...
// Returns the list of crls
handlers.push(
  getHandler({ method: "get",
      path: "/crls/:start/list", func: function (req, res, ctx) {
    console.log("Params (Query): " + JSON.stringify(req.query));
    res.json({ message: 'crls-get' });
}}, { login: true, roles : [ "agtadm" ] }, false));
...
handlers.push(
  getHandler({ method: "get",
      path: "/crls/:id", func: function (req, res, ctx) {
    console.log("Params (Query): " + JSON.stringify(req.query));
